...
echo ERROR: Bun was not found. Please run setup.bat first.
goto failed

:bun_found
if not exist "node_modules" (
    echo ERROR: Project dependencies not found. Please run setup.bat first.
    goto failed
)
...
if errorlevel 1 goto failed
echo multiagents dashboard ready.
popd
exit /b 0
